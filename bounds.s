...
# -I /build/linux-TzXkMG/linux-5.0.0/arch/x86/include
# -I ./arch/x86/include/generated
# -I /build/linux-TzXkMG/linux-5.0.0/include -I ./include
# -I /build/linux-TzXkMG/linux-5.0.0/arch/x86/include/uapi
# -I ./arch/x86/include/generated/uapi
# -I /build/linux-TzXkMG/linux-5.0.0/include/uapi
# -I ./include/generated/uapi -I ubuntu/include
# -I /build/linux-TzXkMG/linux-5.0.0/ubuntu/include
# -I /build/linux-TzXkMG/linux-5.0.0/. -I . -imultiarch x86_64-linux-gnu
# -D __KERNEL__ -D CONFIG_X86_X32_ABI -D CONFIG_AS_CFI=1
# -D CONFIG_AS_CFI_SIGNAL_FRAME=1 -D CONFIG_AS_CFI_SECTIONS=1
# -D CONFIG_AS_FXSAVEQ=1 -D CONFIG_AS_SSSE3=1 -D CONFIG_AS_AVX=1
...
# -include /build/linux-TzXkMG/linux-5.0.0/include/linux/kconfig.h
# -include /build/linux-TzXkMG/linux-5.0.0/include/linux/compiler_types.h
# -MD kernel/.bounds.s.d /build/linux-TzXkMG/linux-5.0.0/kernel/bounds.c
...
# -fconserve-stack -fmacro-prefix-map=/build/linux-TzXkMG/linux-5.0.0/=
...
1:	call	__fentry__
	...
	pushq	%rbp	#
	movq	%rsp, %rbp	#,
# /build/linux-TzXkMG/linux-5.0.0/kernel/bounds.c:19: 	DEFINE(NR_PAGEFLAGS, __NR_PAGEFLAGS);
#APP
# 19 "/build/linux-TzXkMG/linux-5.0.0/kernel/bounds.c" 1
	
.ascii "->NR_PAGEFLAGS $26 __NR_PAGEFLAGS"	#
# 0 "" 2
# /build/linux-TzXkMG/linux-5.0.0/kernel/bounds.c:20: 	DEFINE(MAX_NR_ZONES, __MAX_NR_ZONES);
# 20 "/build/linux-TzXkMG/linux-5.0.0/kernel/bounds.c" 1
	
.ascii "->MAX_NR_ZONES $5 __MAX_NR_ZONES"	#
# 0 "" 2
# /build/linux-TzXkMG/linux-5.0.0/kernel/bounds.c:22: 	DEFINE(NR_CPUS_BITS, ilog2(CONFIG_NR_CPUS));
# 22 "/build/linux-TzXkMG/linux-5.0.0/kernel/bounds.c" 1
	
.ascii "->NR_CPUS_BITS $13 ilog2(CONFIG_NR_CPUS)"	#
# 0 "" 2
# /build/linux-TzXkMG/linux-5.0.0/kernel/bounds.c:24: 	DEFINE(SPINLOCK_SIZE, sizeof(spinlock_t));
# 24 "/build/linux-TzXkMG/linux-5.0.0/kernel/bounds.c" 1
	
.ascii "->SPINLOCK_SIZE $4 sizeof(spinlock_t)"	#
# 0 "" 2
# /build/linux-TzXkMG/linux-5.0.0/kernel/bounds.c:28: }
#NO_APP
	xorl	%eax, %eax	#
	popq	%rbp	#
	ret	
